...
- name: 麋鹿鲁哟
  desc: 大道至简，知易行难
  avatar: https://cdn.jsdelivr.net/gh/chenzeliang/image_store/blog/20200122153807.jpg # 可选
...
```yaml
- name: CHENZELIANG's blog # 昵称
  desc: 积跬步以至千里，喜欢学习喜欢你。 # 介绍
  avatar: https://cdn.jsdelivr.net/gh/chenzeliang/image_store/blog/20200103123203.jpg # 头像
  link: https://chenzeliang.com/  # 链接
```
